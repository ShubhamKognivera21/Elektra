...
WebUI.setText(findTestObject('Object Repository/Page_Iniciar sesin  Liverpool/input_Correo electrnico_username'), Username)

WebUI.setText(findTestObject('Object Repository/Page_Iniciar sesin  Liverpool/input_Contrasea_password'), Password)
...
WebUI.callTestCase(findTestCase('Check Size'), [:], FailureHandling.STOP_ON_FAILURE)
